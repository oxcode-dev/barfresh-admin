        ...
        <nav class="pt-8 h-[calc(100vh-100px)] overflow-y-auto pb-10">
            <ul class="space-y-2">
                <li v-for="(tab, key) in tabs" :key="key">
                    <router-link 
                        :to="tab.link"
                        class="inline-flex items-center space-x-4 px-5 py-3 text-base w-full hover:text-green-800 hover:bg-green-50"
                        :class="checkActiveRoute(tab.link) ? 'text-green-800 bg-green-50' : 'text-gray-500'"
                    >
