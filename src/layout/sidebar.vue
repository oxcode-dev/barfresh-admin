...
<template>
    <div>
        <div class="py-2 px-6 flex justify-center bg-[white] mx-4 mt-4 rounded-lg">
        ...
        <nav class="pt-8 h-[calc(100vh-100px)] overflow-y-auto pb-10">
            <ul class="space-y-2">
                <li v-for="(tab, key) in tabs" :key="key">
                    <router-link 
                        :to="tab.link"
                        class="inline-flex items-center space-x-4 px-5 py-3 text-base w-full text-gray-500 hover:text-green-800 hover:bg-green-50"
                    >
                ...
                <li>
                    <a 
                        ...
                        class="inline-flex items-center space-x-4 px-5 py-3 text-base w-full text-gray-500 hover:text-green-800 hover:bg-green-50"
                    >
                        <span v-html="logoutNav.svg"></span>
